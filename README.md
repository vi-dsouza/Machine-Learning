...
Multiparadigma - Scilab (Laboratorio de matrizes).  
...
Qualquer pessoa pode desenvolver seus pacotes e então submeter ao cran, disponibilizar através do GitHub standalone.
